...
namespace FakeTrello.Tests.DAL
{
    ...
    public class FakeTrelloRepoTests
    {
        ...
        public void CreateFakeDatabase()
        {
            ...
            // let program call Provider from fake table
    ...
    [TestMethod]
        ...
        public void EnsureICanAddBoard()
        {
            ...
            // IQueryable<Board>
            var query_boards = fake_board_table.AsQueryable(); // cast this list as queryable
            ...
            FakeTrelloRepository repo = new FakeTrelloRepository(fake_context.Object/* context in here */);
            ...
            // Act
            repo.AddBoard("My Board", a_user /* Applicaion User in here */);
